...
import { Phone, MapPin, Utensils, Hotel, Send } from "lucide-react";
...
export default function Contact() {
  ...
  return (
    <div className="bg-[#F5F5F0] text-[#020617] min-h-screen overflow-x-hidden">
      <section className="border-b border-[#020617]/5">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 py-14 sm:py-16 lg:py-20 text-center">
