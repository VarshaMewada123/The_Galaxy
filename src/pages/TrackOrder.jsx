...
//                         className="mt-6 bg-[#C6A45C] text-white px-6 py-3 rounded-xl font-bold"
//                       >
//                         Rate Your Order
//                       </button>
//                     )}
  ...
  return (
    <div className="min-h-screen bg-[#F8F9FA]">
      ...
      <div className="mx-auto max-w-2xl px-4 flex items-center justify-between mb-6">
        <button
          onClick={() => navigate(-1)}
          className="flex items-center gap-2 text-gray-600 hover:text-[#C6A45C]"
        >
          <ChevronLeft className="w-5 h-5" />
          Back
        </button>
        ...
        <AnimatePresence mode="wait">
          {loading ? (
            ...
            >
              ...
              <button
                onClick={fetchOrder}
                className="bg-[#C6A45C] text-white px-8 py-3 rounded-full mt-6"
              >
                Try Again
              </button>
            </motion.div>
            ...
            <motion.div
              ...
              className="space-y-6"
            >
              <div className="bg-white rounded-[2.5rem] p-8 border relative">

                <div className="absolute top-0 right-0 p-8 opacity-5">
                  <Package size={120} />
                </div>

                <p className="text-[#C6A45C] font-bold text-sm uppercase mb-2">
                  Order Status
                </p>
              ...
              <div className="bg-gray-900 rounded-[2rem] p-6 text-white flex justify-between">
                <div className="flex gap-4">
                  <div className="h-12 w-12 rounded-full bg-[#C6A45C] flex items-center justify-center font-bold">
                    {order.deliveryPartner?.name?.charAt(0) || "R"}
                  </div>
                ...
                <a
                  href={`tel:${order.deliveryPartner?.phone || "0000000000"}`}
                  className="bg-white text-black h-12 w-12 flex items-center justify-center rounded-full"
                >
                  <Phone size={20} />
                </a>
              </div>
