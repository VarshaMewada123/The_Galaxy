...
export default function Login() {
  ...
  const redirectPath = location.state?.redirectPath || "/checkout";
        ...
        <div className="mt-12 text-center">
          <p className="text-gray-400 text-[12px] tracking-wide">
            ...
            <button
              ...
              className="text-[#C6A45C] font-bold ml-2 border-b border-transparent hover:-[#C6A45C] transition-all cursor-pointer "
            >
              Create Membership
            </button>
          </p>
